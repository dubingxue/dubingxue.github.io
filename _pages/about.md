...
Research Interests
======
My primary research interests include deep learning, graph neural networks and AI for drug discovery and development. The specific topics I have lied in and published several papers as first author include various sequential tasks in drug candidate screening, compound-protein interaction prediction (Du et al., **Drug Discovery Today**, 2022), drug metabolic pathway prediction (Du et al., **ISMB 2022 & Bioinformatics**) , drug pharmacokinetics and safety (ADMET) prediction (Du et al., **RECOMB 2023**) and Drug metabolic stability prediction (Du et al., **Bioinformatics**, Under review, 2023) to obtain reliable drug candidates. These researches are highly expected to speed up the process of drug discovery.
